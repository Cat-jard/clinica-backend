...
INSERT INTO pacientes (id, tipo_documento, nro_documento, apellido_paterno, apellido_materno, nombres, fecha_nacimiento,
                       sexo, telefono, email, direccion, aseguradora, nro_historia, alergias, created_at, updated_at)
VALUES ('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'DNI', '12345678', 'García', 'Pérez', 'Juan Carlos', '1990-05-15',
        'Masculino', '987654321', 'juan.garcia@email.com', 'Av. Principal 123, Lima', 'SIS', 'HC-20260000001', NULL,
        NOW(), NOW());

INSERT INTO pacientes (id, tipo_documento, nro_documento, apellido_paterno, apellido_materno, nombres, fecha_nacimiento,
                       sexo, telefono, email, direccion, aseguradora, nro_historia, alergias, created_at, updated_at)
VALUES ('b0eebc99-9c0b-4ef8-bb6d-6bb9bd380a22', 'DNI', '87654321', 'López', 'Martínez', 'María Elena', '1985-08-22',
        'Femenino', '912345678', 'maria.lopez@email.com', 'Jr. Secundaria 456, Arequipa', 'EsSalud', 'HC-20260000002',
        'Penicilina', NOW(), NOW());

-- ==================== CONSENTIMIENTOS INFORMADOS ====================

-- Consentimiento 1: Paciente Juan Carlos - FIRMADO (aceptado=true, con firma)
INSERT INTO consentimientos_informados (id, paciente_id, tipo, texto_legal, texto_legal_hash, version_texto,
                                        firma_base64, firma_hash, aceptado, fecha_exposicion, fecha_firma, ip_origen,
                                        user_id, metadata, created_at)
VALUES ('c0eebc99-9c0b-4ef8-bb6d-6bb9bd380a33',
...
INSERT INTO consentimientos_informados (id, paciente_id, tipo, texto_legal, texto_legal_hash, version_texto,
                                        firma_base64, firma_hash, aceptado, fecha_exposicion, fecha_firma, ip_origen,
                                        user_id, metadata, created_at)
VALUES ('d0eebc99-9c0b-4ef8-bb6d-6bb9bd380a44',
